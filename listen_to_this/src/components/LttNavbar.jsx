...
const LttNavbar = (props) => {
  ...
  return (
    <Navbar
      expand="lg"
      className="d-flex justify-content-between secondary-color border primary-border-color /*border border-2 border-black*/ shadow rounded rounded-2"
    >
      <Container className="d-flex row-cols-4 row-cols-lg-1 flex-wrap text-start">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="#home" className='tertiary-text'>Home</Nav.Link>
            <Nav.Link href="#link" className='tertiary-text'>Link</Nav.Link>
          </Nav>
          <Nav>
