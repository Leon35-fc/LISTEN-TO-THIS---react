...
const LttNavbar = (props) => {
  ...
  return (
    <Navbar
      expand="lg"
      className="d-flex justify-content-between secondary-color border border-2 primary-border-color rounded rounded-2"
    >
      <Container className="d-flex row-cols-4 row-cols-lg-1 flex-wrap text-start">
        <Navbar.Brand href="#home">
          <span className="primary-color tertiary-text px-2 rounded rounded-1 fs-2 fw-semibold">
            Listen to this!
          </span>
        </Navbar.Brand>
